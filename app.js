...
const WHITELIST_ID = process.env.WHITELIST_ID
...
const OWNER_SPLIT = process.env.OWNER_SPLIT
const BORROWER_SPLIT = process.env.BORROWER_SPLIT
const THIRD_PARTY_SPLIT = process.env.THIRD_PARTY_SPLIT
